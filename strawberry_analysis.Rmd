...
## SPECIES RICHNESS: ROOTS AND SHOOTS ########################################
# interaction model
...
shapiro.test(filtered_fit$residuals)
...
#additive model 
mass_fit2 = aov(RootShootRatio ~ Inoculation + Water, data = rs_dat)
Anova(rs_fit2, type = "2")
plot(rs_fit2)

#plot the filtered data to check the spread
ggplot(rs_dat, aes(RootShootRatio)) +
  facet_grid(Water ~ Inoculation) +
  # scale_x_log10() +
  geom_histogram()
